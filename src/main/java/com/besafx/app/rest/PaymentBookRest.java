...
public class PaymentBookRest {
    ...
    private final String FILTER_TABLE = "**,branch[id,code,name],lastPerson[id,contact[id,firstName,forthName]],payment[id,code]";
    private final String FILTER_PAYMENT_BOOK_COMBO = "id,code,fromCode,toCode,maxCode";
