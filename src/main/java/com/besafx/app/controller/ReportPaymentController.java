...
public class ReportPaymentController {
    ...
    public void printPaymentByBranch(
        ...
        if (startDate == null && endDate == null) {
            ...
            paymentList = paymentService.findByAccountCourseMasterBranchAndDateBetween(branch, new Date(startDate), new Date(endDate));
    ...
    public void printPaymentByMaster(
        ...
        if (startDate == null && endDate == null) {
            ...
            paymentList = paymentService.findByAccountCourseMasterAndDateBetween(master, new Date(startDate), new Date(endDate));
            map.put("param2", map.get("param2").toString()
                    .concat(" ")
                    .concat("التاريخ من: ")
                    .concat(DateConverter.getHijriStringFromDateLTR(startDate.longValue()))
    ...
    public void printPaymentByCourse(
        ...
        if (startDate == null && endDate == null) {
            ...
            paymentList = paymentService.findByAccountCourseAndDateBetween(course, new Date(startDate), new Date(endDate));
            map.put("param2", map.get("param2").toString()
                    .concat(" ")
                    .concat("التاريخ من: ")
                    .concat(DateConverter.getHijriStringFromDateLTR(startDate.longValue()))
    ...
    public void printPaymentByAccountIn(
        ...
        if (startDate == null && endDate == null) {
            ...
            paymentList = paymentService.findByAccountInAndDateBetween(accountList.stream().map(id -> accountService.findOne(id)).collect(Collectors.toList()), new Date(startDate), new Date(endDate));
            map.put("param2", map.get("param2").toString()
                    .concat(" ")
                    .concat("التاريخ من: ")
                    .concat(DateConverter.getHijriStringFromDateLTR(startDate.longValue()))
