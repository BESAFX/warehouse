...
var timerModule = angular.module("timer", []).directive("timer", ["$compile", function (a) {
    return {
        ...
        controller: ["$scope", "$element", "$attrs", "$timeout", "I18nService", "$interpolate", "progressBarService", function (b, c, d, e, f, g, h) {
            ...
            k.init(b.language, b.fallback), b.displayProgressBar = 0, b.displayProgressActive = "active", 0 === c.html().trim().length ? c.append(a("<span>" + g.startSymbol() + "millis" + g.endSymbol() + "</span>")(b)) : c.append(a(c.contents())(b)), b.startTime = null, b.endTime = null, b.timeoutId = null, b.countdown = angular.isNumber(b.countdownattr) && parseInt(b.countdownattr, 10) >= 0 ? parseInt(b.countdownattr, 10) : void 0, b.isRunning = !1, b.$on("timer-start", function () {
                ...
                b.startTime = b.startTimeAttr ? moment(b.startTimeAttr) : moment(), b.endTime = b.endTimeAttr ? moment(b.endTimeAttr) : null, angular.isNumber(b.countdown) || (b.countdown = angular.isNumber(b.countdownattr) && parseInt(b.countdownattr, 10) > 0 ? parseInt(b.countdownattr, 10) : void 0), i(), l(), b.isRunning = !0, b.$emit("timer-started", {
                ...
                i(), b.countdownattr && (b.countdown += 1), b.startTime = moment().diff(moment(b.stoppedTime).diff(moment(b.startTime))), l(), b.isRunning = !0, b.$emit("timer-started", {
                    timeoutId: b.timeoutId,
                    millis: b.millis,
                    seconds: b.seconds,
                    minutes: b.minutes,
                ...
                b.startTime = b.startTimeAttr ? moment(b.startTimeAttr) : moment(), b.endTime = b.endTimeAttr ? moment(b.endTimeAttr) : null, b.countdown = angular.isNumber(b.countdownattr) && parseInt(b.countdownattr, 10) > 0 ? parseInt(b.countdownattr, 10) : void 0, i(), l(), b.isRunning = !1, b.clear(), b.$emit("timer-reset", {
                    timeoutId: timeoutId,
                    millis: b.millis,
                    seconds: b.seconds,
                    minutes: b.minutes,
                ...
                i(), b.isRunning = !1
            }), b.countdownattr ? (b.millis = 1e3 * b.countdownattr, b.addCDSeconds = function (a) {
    ...
    return {
        restrict: "EA", scope: !0, controller: ["$scope", function (a) {
            a.timerStatus = "reset", a.$on("timer-started", function () {
