!function (global, definition) {
    ...
    var scannerDef = {
        ...
        initialize: function () {
            ...
            try {
                if (this.canUseJavaAppletImpl() && this.doesCurrentBrowserSupportNPAPI()) {
            ...
            if (this.canUseWebSocketImpl()) {
                if (!this.hasJava() || this.bowser.firefox) {
                    scanner.connectToScanWebSocketServer();
                } else {
                    this.logToConsole("Java: " + deployJava.getJREs());
                }
            }
        ...
        funcCallToWebSocket: function () {
            ...
            try {
                ...
                this.functionReturn(false, "Failed: " + e, null, null, null, null);
        ...
        funcCallResponseFromWebSocket: function (successful, response) {
            if (successful) {
                ...
                try {
                    ...
                    this.functionReturn(false, "Failed to parse JSON: " + response, null, null, null, null);
                    return;
                }
                if (returned instanceof Array) {
                    this.functionReturn(returned[0], returned[1], returned[2], returned[3], returned[4], returned[5]);
                } else {
                    this.functionReturn(false, "JSON returned from WebSocket is not array", null, null, null, null);
                }
            } else {
                this.functionReturn(false, "Failed due to WebSocket error", null, null, null, null);
            }
        },
        functionReturn: function (successful, mesg, log, callbackFuncName, argCount, args) {
            this.requestStatus = this.REQUEST_STATUS_COMPLETE;
            this.requestStatusSetOn = new Date().getTime();
            this.requestCallback(successful, mesg, args);
        },
        ...
        hasEverConnected: function () {
            return this.readFromLocalStorage("scannerjs_last_connected") || this.getCookie("scannerjs_last_connected");
        },
        onScanWebSocketOpen: function (ws, open) {
            try {
                var connectedOnString = new Date().toString();
                scanner.writeToLocalStorage("scannerjs_last_connected", connectedOnString);
                scanner.setCookie("scannerjs_last_connected", connectedOnString);
            } catch (e) {
            }
        ...
        addInstallPromptDomElementIfNotExists: function () {
            ...
            var divPromptModel = {
                ...
                "children": [{
                    ...
                    "name": "h3",
                    "attributes": {"style": "margin-top: 0px;", "text": "Please Enable Scanning"}
                }, {
                    "name": "div",
                    "attributes": {"class": "java", "style": "display: none;"},
                    "children": [{
                        "name": "p",
                        "attributes": {"text": "In order to scan directly from your browser, you need to either enable Java or install the scan app: "}
                    }, {
                        "name": "table",
                        "attributes": {"width": "100%"},
                        "children": [{
                            "name": "td",
                            "attributes": {"width": "50%", "align": "center", "valign": "top"},
                            "children": [{"name": "h4", "attributes": {"text": "Either Option 1:"}}, {
                                "name": "a",
                                "attributes": {
                                ...
                                }, {"name": "span", "attributes": {"text": "; once done, please "}}, {
                                    "name": "button",
                                    "attributes": {
                                        "type": "button",
                        ...
                        }, {"name": "td", "attributes": {"width": "10px"}}, {
                            "name": "td",
                            "attributes": {"width": "1px", "style": "background-color: #cccccc;"}
                        }, {"name": "td", "attributes": {"width": "10px"}}, {
                            "name": "td",
                            "attributes": {"align": "center", "valign": "top"},
                            "children": [{"name": "h4", "attributes": {"text": "Or Option 2:"}}, {
                                "name": "a",
                                "attributes": {
                                ...
                                }, {"name": "span", "attributes": {"text": ". No need to refresh page."}}]
                            }]
                        }]
                    }]
                }, {
                    "name": "div",
                    "attributes": {"class": "nojava", "style": "display: none;"},
                    "children": [{
                        "name": "p",
                        "attributes": {"text": "In order to scan directly from your browser, you need to install the scan app: "}
                    }, {
                        "name": "a",
                        "attributes": {
                            "class": "icon-action icon-action-install-app",
                        ...
                        "children": [{
                            "name": "a",
                            "attributes": {"href": urlAppDownload, "target": "_blank", "text": "Download and run it"}
                        }, {"name": "span", "attributes": {"text": ". No need to refresh page."}}]
                    }]
                }]
            };
        ...
        addScanReadyPromptDomElementIfNotExists: function () {
            ...
            var divPromptModel = {
                ...
                "children": [{
                    ...
                    "children": [{
                        "name": "span",
                        "attributes": {"style": "font-size: larger; color: #00A000;", "text": "✔"}
                    }, {"name": "span", "attributes": {"text": " SCANNING ENABLED"}}]
                }, {
                    "name": "p",
                    "attributes": {
        ...
        createAppletDomElement: function (id, codebase, archive, className, width, height) {
            var appletModel = {
                ...
                }, {"name": "param", "attributes": {"name": "java_version", "value": "1.6+"}}, {
                    "name": "param",
                    "attributes": {"name": "java_arguments", "value": "-Xmx512m"}
                }, {"name": "param", "attributes": {"name": "separate_jvm", "value": "true"}}, {
                    "name": "param",
                    "attributes": {"name": "codebase_lookup", "value": "false"}
                }, {"name": "param", "attributes": {"name": "mayscript", "value": "mayscript"}}]
            };
        ...
        deployJava: function () {
            ...
            var o = {
            ...
            }, u = (o.object.concat(o.core, o.i18n, o.events), o.applet.concat(o.core)), h = {
                debug: null,
                version: "20120801",
                ...
                installLatestJRE: function (e) {
                    ...
                    var n = this.getBrowser(), r = navigator.platform.toLowerCase();
                ...
                versionCheck: function (t) {
                    var n = 0, i = t.match(version_regex_with_family_modifier);
                    if (null != i) {
                ...
                isWebStartInstalled: function (t) {
                    ...
                    var i = !1, r = t.match(version_regex_strict);
                ...
                compareVersionToPattern: function (e, t, n, i) {
                    ...
                    if (null != r) {
                        ...
                        if (i) {
                            for (var l = 0; o > l; ++l) {
                                var u = parseInt(s[l]), h = parseInt(t[l]);
                                if (h > u) {
                                    return !1;
                                }
                                if (u > h) {
                    ...
                    if (null != navigator.mimeTypes) {
                        for (var t = 0; t < navigator.mimeTypes.length; t++) {
                            if (navigator.mimeTypes[t].type == this.mimeType && navigator.mimeTypes[t].enabledPlugin) {
                                var n = {
                                    name: "embed",
                                    attributes: {id: "deployJavaPlugin", type: this.mimeType, hidden: "true"}
                                };
                        ...
                        if (!e) {
                            for (var t = 0; t < navigator.mimeTypes.length; t++) {
                                if (navigator.mimeTypes[t].type == this.oldMimeType && navigator.mimeTypes[t].enabledPlugin) {
                                    ({
                                        name: "embed",
                                        attributes: {id: "deployJavaPlugin", type: this.oldMimeType, hidden: "true"}
                                    });
        ...
        bowser: (function () {
            function t(t) {
                ...
                var i = n(/(ipod|iphone|ipad)/i).toLowerCase(), s = /like android/i.test(t),
                    o = !s && /android/i.test(t), u = /CrOS/.test(t), a = n(/edge\/(\d+(\.\d+)?)/i),
                    f = n(/version\/(\d+(\.\d+)?)/i), l = /tablet/i.test(t), c = !l && /[^-]mobi/i.test(t), h;
                /opera|opr/i.test(t) ? h = {
                    ...
                    chrome: e,
                    version: n(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)
                } : i ? (h = {name: i == "iphone" ? "iPhone" : i == "ipad" ? "iPad" : "iPod"}, f && (h.version = f)) : /sailfish/i.test(t) ? h = {
                    name: "Sailfish",
                    sailfish: e,
                ...
                } : o ? h = {name: "Android", version: f} : /phantom/i.test(t) ? h = {
                    name: "PhantomJS",
                    phantom: e,
                ...
                } : /safari/i.test(t) ? h = {name: "Safari", safari: e, version: f} : h = {
                    name: n(/^(.*)\/(.*) /),
                    version: r(/^(.*)\/(.*) /)
