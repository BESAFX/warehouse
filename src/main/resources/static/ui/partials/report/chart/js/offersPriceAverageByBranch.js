app.controller('offersPriceAverageByBranchCtrl', ['BranchService', '$scope', '$rootScope', '$timeout', '$uibModalInstance',
    function (BranchService, $scope, $rootScope, $timeout, $uibModalInstance) {
        ...
        $scope.submit = function () {
            ...
            if ($scope.buffer.startDate && $scope.buffer.endDate) {
                window.open('/report/ChartOffersPriceAverageByBranch?'
                    + "branchesList=" + listId + "&"
