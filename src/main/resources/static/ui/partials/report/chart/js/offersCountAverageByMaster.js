app.controller('offersCountAverageByMasterCtrl', ['MasterService', '$scope', '$rootScope', '$timeout', '$uibModalInstance',
    function (MasterService, $scope, $rootScope, $timeout, $uibModalInstance) {
        ...
        $scope.submit = function () {
            ...
            if ($scope.buffer.startDate && $scope.buffer.endDate) {
                window.open('/report/ChartOffersCountAverageByMaster?'
                    + "mastersList=" + listId + "&"
