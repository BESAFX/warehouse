...
gulp.task('scripts', function () {
    ...
    gulp.src([
        ...
        './init/factory/billPurchasePaymentFactory.js',
        ...
        './partials/billPurchase/billPurchaseOldCreate.js',
        './partials/billPurchase/billPurchaseDetails.js',
        './partials/billPurchaseProduct/billPurchaseProductCreate.js',
        './partials/billPurchasePayment/billPurchasePaymentFilter.js',
        './partials/billPurchasePayment/billPurchasePaymentCreate.js',
